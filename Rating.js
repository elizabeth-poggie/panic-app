...
const REACTIONS = [
    ...
    { label: "Bad", src: require('./assets/rating/sad.png'), bigSrc: require('./assets/rating/sad_big.png') },
    { label: "OK", src: require('./assets/rating/ambitious.png'), bigSrc: require('./assets/rating/ambitious_big.png') },
    { label: "Good", src: require('./assets/rating/smile.png'), bigSrc: require('./assets/rating/smile_big.png') },
    { label: "Fantastic", src: require('./assets/rating/surprised.png'), bigSrc: require('./assets/rating/surprised_big.png') },
  ];
  const WIDTH = 320;
